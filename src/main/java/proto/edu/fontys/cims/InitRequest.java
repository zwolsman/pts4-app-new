...
public final class InitRequest {
  ...
  /**
   * Protobuf type {@code edu.fontys.cims.proto.Message}
   */
  public  static final class Message extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:edu.fontys.cims.proto.Message)
      MessageOrBuilder {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof edu.fontys.cims.InitRequest.Message)) {
        return super.equals(obj);
      }
      edu.fontys.cims.InitRequest.Message other = (edu.fontys.cims.InitRequest.Message) obj;

      boolean result = true;
      result = result && (getId()
          == other.getId());
      result = result && (getCrisisid()
          == other.getCrisisid());
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + ID_FIELD_NUMBER;
      hash = (53 * hash) + getId();
      hash = (37 * hash) + CRISISID_FIELD_NUMBER;
      hash = (53 * hash) + getCrisisid();
    ...
    public static final class Builder extends
      ...
      // Construct using edu.fontys.cims.InitRequest.Message.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public Builder mergeFrom(edu.fontys.cims.InitRequest.Message other) {
        ...
        if (other.getCrisisid() != 0) {
          setCrisisid(other.getCrisisid());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        edu.fontys.cims.InitRequest.Message parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (edu.fontys.cims.InitRequest.Message) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      // @@protoc_insertion_point(builder_scope:edu.fontys.cims.proto.Message)
    }

    // @@protoc_insertion_point(class_scope:edu.fontys.cims.proto.Message)
    private static final edu.fontys.cims.InitRequest.Message DEFAULT_INSTANCE;
    static {
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_edu_fontys_cims_proto_Message_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tamp\030\n \001(\t\"5\n\007Message\022\n\n\002id\030\001 \001(\005\022\020\n\010cri" +
      "sisid\030\002 \001(\005\022\014\n\004text\030\003 \001(\tB\021\n\017edu.fontys.",
      "cimsb\006proto3"
    };
    ...
    internal_static_edu_fontys_cims_proto_Message_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_edu_fontys_cims_proto_Message_descriptor,
        new java.lang.String[] { "Id", "Crisisid", "Text", });
  }
